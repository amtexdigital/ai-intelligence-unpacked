...
const platforms = [
  {
    ...
    url: "https://www.youtube.com/@DetectingIntelligence",
    description: "Full show with visuals & breakdowns",
  },
  {
    name: "X (Twitter)",
    icon: (
    ...
    url: "https://x.com/detecting_ai?s=20",
    description: "Simulcast & live discussions",
  },
  {
    name: "Twitch",
    icon: (
    ...
    url: "https://www.twitch.tv/detecting_intelligence",
    description: "Chat with the community live",
  },
];
